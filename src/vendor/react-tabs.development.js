    ...
    (function(_Component) {
        ...
        return deepMap(children, function(child) {
          ...
          if (isTabList(child)) {
            ...
            if (canUseActiveElement) {
              wasTabFocused = React__default.Children.toArray(child.props.children)
                .filter(isTab)
                .some(function(tab, i) {
      ...
      _proto.render = function render() {
        ...
        var _this$props3 = this.props,
          ...
          attributes = _objectWithoutPropertiesLoose(_this$props3, [
            'children',
            'className',
    ...
    (function(_Component) {
      ...
      _proto.render = function render() {
        ...
        var _this$props2 = this.props,
          ...
          attributes = _objectWithoutPropertiesLoose(_this$props2, [
            'children',
            'className',
            'disabled',
            'disabledClassName',
        ...
        return React__default.createElement(
          ...
          _extends({}, attributes, {
            className: classnames(
              className,
              ((_cx = {}), (_cx[selectedClassName] = selected), (_cx[disabledClassName] = disabled), _cx)
            ),
            ref: function ref(node) {
              _this.node = node
    ...
    (function(_Component) {
      ...
      _proto.render = function render() {
        ...
        var _this$props = this.props,
          ...
          attributes = _objectWithoutPropertiesLoose(_this$props, [
            'children',
            'className',
            'forceRender',
            'id',
